...
save(fit.data.SL, file="/data/markscan_authorized_users/bergquist/EI/fullfitv9.Rdata")
save(cSums, file="/data/markscan_authorized_users/bergquist/EI/fullcSumsv9.Rdata")
save(SLPreds, file="/data/markscan_authorized_users/bergquist/EI/fullSLPredsv9.Rdata")
save(coef, file="/data/markscan_authorized_users/bergquist/EI/fullcoefv9.Rdata")
save(cvRisk, file="/data/markscan_authorized_users/bergquist/EI/fullcvRiskv9.Rdata")
save(Z, file="/data/markscan_authorized_users/bergquist/EI/fullZv9.Rdata")
save(fitLibrary, file="/data/markscan_authorized_users/bergquist/EI/fullfitLibraryv9.Rdata")